...
const OPTIONS = [
    { id: 'bearish', label: 'Bearish (250M)', color: '#ef4444', percentage: 15 },
    { id: 'slightly_bearish', label: 'Slightly Bearish (500M)', color: '#f59e0b', percentage: 25 },
    { id: 'standard', label: 'Standard (1B)', color: '#22d3ee', percentage: 40 },
    { id: 'bullish', label: 'Bullish (10B)', color: '#10b981', percentage: 20 },
];
        ...
        <div className="w-full max-w-2xl mx-auto p-6 bg-white/5 border border-white/10 rounded-2xl backdrop-blur-md">
            ...
            {hasVoted && (
                <p className="text-center text-gray-500 text-sm mt-6">
                    Thanks for voting! These are community estimates.
                </p>
            )}
        </div>
    );
